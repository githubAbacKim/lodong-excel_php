...
function newPersonalityFormat(){
    $newPersonalityArr = [];

    foreach (self::$personalityElementsArr as $personality) {
        foreach ($personality['questionSet'] as $key => $num) {
            // $newPersonalityArr[] = [
            //     'type' => strtolower($personality['type']),
            //     'num' => $num,
            //     'correctAnswer' => $personality['correctAnswer'][$num],
            //     'answerShape' => $personality['answerShape'][$num],
            //     'shapeModification' => $personality['shapeModification'][$num],
            //     'modificationConversionToActual' => $personality['modificaitonConversionToActual'][$num],
            //     'modificationValue' => $personality['modificationValue'][$num],
            // ];
            echo "['type'=>".strtolower($personality['type']).",'num'=>".$num.",'correctAnswer'=>".$personality['correctAnswer'][$num].",'answerShape'=>".$personality['answerShape'][$num].",'shapeModification'=>".$personality['shapeModification'][$num].",'modificationConversionToActual'=>".$personality['modificaitonConversionToActual'][$num].",'modificationValue'=>".$personality['modificationValue'][$num].'],<br>';
        }
    }
    
    // Example for accessing data
    /* $examplePersonality = $newPersonalityArr[0];
    echo print_r($examplePersonality); */
