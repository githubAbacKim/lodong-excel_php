...
function createNewPersonalityData(){
    ...
    foreach (self::$personalityElementsArr as $personalityElement) {
        ...
        foreach ($questionSet as $questionNum) {
            ...
            foreach ($modifiedAnswer as $value) {
                if ($value['num'] == $questionNum) {
                    // Add the corresponding values to correctAnswer and modifiedAnswer
                    $correctAnswer[] = $personalityElement['correctAnswer'][$questionNum];
                    $modifiedAnswer[] = $value['modifiedAnswer'];
                    // break; // Break the inner loop once found
                    echo $personalityElement['correctAnswer'][$questionNum];
                }
                echo $value['modifiedAnswer'];
            }
